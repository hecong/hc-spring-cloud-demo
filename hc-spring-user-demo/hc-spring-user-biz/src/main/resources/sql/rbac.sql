...
(
    ...
    enterprise_id bigint                             null comment '企业ID，NULL表示平台角色',
    creator       varchar(50)                        null comment '创建人',
    updater       varchar(50)                        null comment '更新人',
    create_time   datetime default CURRENT_TIMESTAMP null comment '创建时间',
    update_time   datetime default CURRENT_TIMESTAMP null on update CURRENT_TIMESTAMP comment '更新时间',
...
create index idx_sys_role_enterprise_id on user.sys_role (enterprise_id);
...
-- ============================================================
INSERT INTO user.sys_user (id, username, password, name, status)
VALUES (1, 'admin', '$2a$10$EqKcp1WFKVN0kPMJgE0y3Oe7wYvI6gRQ0m0X5FLhQGqJ3vBmWfDHe', '管理员', 1)
